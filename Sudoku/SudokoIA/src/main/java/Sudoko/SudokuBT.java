...
public class SudokuBT {
    ...
    public boolean findSolution(int i, int j) {
        ...
        if (i == -1 && j == -1) {
            if (solutionChecker()) {
                System.out.println("Voilà la solution :");
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Bienvenue dans le jeu de sudoko");
        System.out.println("- Tapez 1 si vous voulez voire un seule résultat de sudoko  ");
        System.out.println("- Tapez 2 si vous voulez voire tous les résultat possible pour le sudoku ");
        ...
        switch (number) {
            ...
            default: {
                System.err.println("Vous devez choisir comme nombre : 1 ou 2");
                System.exit(2);
                break;
            }
        }
